        ...
        <Row className="w-100 align-items-center">
          <Slide left>
            <div className="col-xl-12 col-lg-12 col-sm-10 text-center about__content">
              <Container>
                <p>
                  “World’s No.1 Yield Box Auto-Staking and Auto-Reflection
                  Protocol (YASAR) with every 5-minute Reward and every hour for
                  7% <span className="BUSD__color">BUSD</span> Reflection”
                </p>
              </Container>
